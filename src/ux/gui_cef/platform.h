#ifndef BROWSER_CEF_PLATFORM_H
#define BROWSER_CEF_PLATFORM_H
...
/**
 * @class gui_browser_cef_t
 * @brief
 */
class gui_browser_cef_t : public platform_driver_interface_t {
public:
  ...
  gui_browser_cef_t(int _argc, char **_argv, std::stringstream &_out,
