...
uxdev::window_t &uxdev::window_t::operator()(const u_int16_t &_row,
...
uxdev::window_t &uxdev::window_t::operator()(const std::string &operation) {
...
uxdev::window_t &
uxdev::window_t::operator()(const std::string &event_description,
                            event_handler_t &evt_handler) {
  driver_instance->listen(event_description, evt_handler);
}

uxdev::window_t &uxdev::window_t::operator()(
