#ifndef GUI_ENLIGHTENMENT_EFL
#define GUI_ENLIGHTENMENT_EFL
...
/**
 * @class gui_enlightenment_efl_t
 * @brief
 */
class gui_enlightenment_efl_t : public platform_driver_interface_t {
public:
  ...
  ~gui_enlightenment_efl_t();

  gui_enlightenment_efl_t(int _argc, char **_argv, std::stringstream &_out,
